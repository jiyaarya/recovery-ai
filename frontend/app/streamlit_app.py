...
st.markdown(
    textwrap.dedent(
        ...
        .visual-bars i:nth-child(5) {
            height: 52%;
        }

        .visual-bars i:nth-child(6) {
            height: 78%;
        }

        .visual-bars i:nth-child(7) {
            height: 92%;
        }
...
with st.sidebar:
    ...
    st.caption(
        "AI-powered recovery decisions with bounded actions "
    ...
    textwrap.dedent(
        ...
        <div class="hero">
            ...
            <div class="hero-content">
                ...
                <div class="hero-text">
                    Detect failed payments, estimate recovery
                    probability, choose the right intervention,
                    and execute bounded recovery workflows
    ...
    st.html(
        textwrap.dedent(
            ...
            <div class="glass-card">
                ...
                <div class="section-description">
                    Upload failed-payment transactions and let
                    the ML engine generate fresh recovery decisions.
                </div>
...
# ============================================================
    ...
    with st.form(
        ...
        with col2:
            ...
            successful_payments = st.number_input(
                "Successful Payments",
                min_value=0,
                value=20,
            )
            ...
            failed_payments = st.number_input(
                "Failed Payments",
                min_value=0,
                value=3,
            )
            ...
            previous_recovery_rate = st.slider(
        ...
        with col3:
            ...
            days_since_last_payment = st.number_input(
            ...
            checkout_abandoned = st.selectbox(
                "Checkout Abandoned",
                [0, 1],
            )
